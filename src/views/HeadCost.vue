...
import DownloadDialog from '../components/DownloadDialog.vue'
  ...
  export default {
    ...
    created() {
      ...
      if (this.role.includes('ALL') || this.role.includes('HEAD_COST')) {
        this.getdata ()
        this.getdata_amount ()
      }else {
    ...
    methods:{
      ...
      getdata_amount () {
        ...
        this.axios.get(process.env.VUE_APP_API + '/dashboard/document/amount/cost', headers).then((response) => {
      ...
      getdata () {
        ...
        this.axios.get(process.env.VUE_APP_API + '/dashboard/document/head/cost?page=' + this.page + '&status=' + this.status + '&search=' + this.search, headers).then((response) => {
          this.loading = false
