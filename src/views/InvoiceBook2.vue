      ...
      <div>
        <v-row>
          <v-col
            ...
            "
          >
            <h3 style="font-weight: 700">หนังสือทวงหนี้ 2</h3>
          </v-col>
              ...
              <v-col cols="12">
                <v-card>
                  <v-card-text>
                    ...
                    <!-- -----------------------------end submitted selected---------------------------------------- -->

                    <!-- -----------------------------Un - submitted selected---------------------------------------- -->
                    <v-dialog
...
export default {
  ...
  methods: {
    ...
    submit_all(name) {
      ...
      // เพิ่มมาใหม่
      // this.set_memo.memo_date = new Date().toISOString().slice(0,10)
    ...
    SubmitInvoiceMain(name) {
      ...
      // data_list.memo_date = this.modal_submit_all[index].memo_date;
      // data_list.memo_date = new Date(this.modal_submit_all[index].memo_date).toJSON();
      // due_date: new Date(item.due_date).toJSON(),
      // String(new Date(this.set_memo.memo_date).getTime() / 1000)
      // data_list.memo_date = String(new Date(this.modal_submit_all[index].memo_date).getTime() / 1000);
    ...
    getInvoice() {
      ...
      this.axios
        .get(
          process.env.VUE_APP_API +
            "/debt/customer/debt_second?size=" +
