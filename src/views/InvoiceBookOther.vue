      ...
      <div>
        <v-row>
          <v-col
            ...
            "
          >
            <h3 style="font-weight: 700">หนังสือทวงหนี้อื่นๆ</h3>
          </v-col>
            ...
            <v-card class="font-text">
              <v-toolbar dark color="indigo">
                <v-toolbar-title class="font-text">
                  <div class="d-flex">
                    <div style="width: 185px; color: #fffd9e">
                      (หนังสือทวงหนี้อื่นๆ) : 
                    </div>
                    {{ name_open_dialog }}
                  </div></v-toolbar-title
                  ...
                  <v-card-text>
                    <div class="d-flex" style="width: 100%">
                      <v-btn
                        ...
                        "
                        :disabled="
                          check_submitted == true || role_status == 'admin' || role_status == 'viewer' || check_submitted2 == true || check_down_service == false
                        "
                      ...
                      <v-btn
                        ...
                        "
                        :disabled="
                          check_unsubmitted == true || role_status == 'admin' || role_status == 'viewer' || check_down_service == false
                        "
                        style="margin-bottom: 10px"
                      >
                        Unsubmit
                      ...
                      <v-btn
                        ...
                        "
                        :disabled="
                          selected_1.length == 0 || role_status == 'admin' || role_status == 'viewer' || check_down_service == false
                        "
                        style="margin-bottom: 10px"
                      >
                        Hold
                      ...
                      <v-btn
                        text
                        color="#52665A"
                        @click="(open_letter_other = true), submit_all('letter_other')"
                        
                        :disabled="
                          selected_1.length == 0 || role_status == 'admin' || role_status == 'viewer' || check_down_service == false || check_letter == false
                        "
                        style="margin-bottom: 10px"
                      >
                        LETTER OTHER
                      ...
                      <!-- <v-btn
                        text
                        color="#A560C2"
                        @click="(invoice_book_close = true) ,submit_all('invoice_book_close')"
                        :disabled="
                      ...
                      <v-card>
                        <v-card-title class="text-h5">
                          <div
                            ...
                            "
                          >
                            <v-avatar color="#52665A" outlined size="30">
                              <v-icon dark> mdi-file-sign </v-icon>
                            </v-avatar>

                            <div class="font-text" style="color: #52665A">
                              แก้ไขข้อมูลการออกทวงหนี้
                            </div>
                            ...
                            <!-- <div
                              ...
                              "
                            >
                              Version:Thai &nbsp;<div><v-switch v-model="version" @change="type_change_version(version)"></v-switch></div>&nbsp; English
                            </div> -->
                          </div>
                            ...
                            >
                              ...
                              <div class="d-flex">
                                <input
                                  ...
                                  class="form-control"
                                  placeholder="Select Date"
                                  v-model="memo_date_today"
                                />
                                <button
                                  class="btn"
                                  style="font-size: 18px"
                                  @click="clearDate_memo_today(memo_date_today)"
                                >
                                  x
                                </button>
                              </div>
                        ...
                        <v-card-text>
                          <div class="font-text">
                            <div
                              ...
                              style="height: 280px; word-break: break-all"
                            >
                              <table id="table_select_modal_letter_other">
                                <tr style="font-weight: bold">
                                  <th style="width: 300px; padding: 5px">
                                    Invoice No&nbsp;
                                  </th>
                                  ...
                                  <th style="width: 300px; padding: 5px; text-align: center">
                                    จำนวนครั้งที่ทวงหนี้ &nbsp;
                                  </th>
                                </tr>
                        ...
                        <v-card-actions>
                          ...
                          <v-btn
                            color="#506084"
                            text
                            @click="(open_letter_other = false),save_letter_other()"
                          >
                            SAVE
                            <v-icon dark> mdi-pencil </v-icon>
                          </v-btn>
                          ...
                          <div class="font-text">
                            ...
                            >
                              <table id="table_select_modal_interest">
                                ...
                                <tr
                                  v-for="item in modal_submit_all_2"
                                  :key="item.invoice_no"
                                  style="border-bottom: 1px solid gainsboro"
                                >
                                  <td style="width: 300px">
                        ...
                        >
                          ...
                          <!-- <template v-slot:[`item.action`]="{ item }">
                            <v-btn
                              ...
                              :disabled="
                                role_status != 'super_admin' || item.status_rpa == 'submitted'
                              "
                            >
                              CONFIRM</v-btn
                            >
...
export default {
  ...
  data: () => ({
    ...
    //   },
      ...
      // {
      //   text: "จำนวนวันที่ครบหนังสือทวงหนี้ครั้งล่าสุด",
      //   value: "",
      //   width: "220px",
      //   sortable: true,
      //   align: "center",
  ...
  methods: {
    ...
    enterSelect() {
      ...
      for (let index = 0; index < this.selected_1.length; index++) {
        if (this.selected_1[index].status_rpa != "submitted") {
      ...
      for (let index = 0; index < this.selected_1.length; index++) {
        if (this.selected_1[index].status_rpa != "down_service") {
          this.check_down_service = true;
        } else {
          this.check_down_service = false;
          break;
        }
      }
    ...
    set_date(){
      ...
      this.modal_submit_all_2.forEach((element) => {
        ...
        const firstDate = new Date(element.end_date);
        const secondDate = new Date(element.start_date);
        let day = Math.round(Math.abs((firstDate - secondDate) / oneDay));
        element.day = day + 1

        const xxx = element.interest_rate.split("%")
        const xxx2 = xxx[0]/100
        
        element.interest_amount = ((element.amount * xxx2)/30)*(day +1)
    ...
    submit_all(name) {
      ...
      if(name == "interest"){
        ...
        this.total_amount = 0;
        this.total_interest = 0;
        // this.modal_submit_all_2 = this.selected_1;
        // this.modal_submit_all_2.forEach((element) =>{
        ...
        this.selected_1.forEach((element) =>{
          ...
          const secondDate = new Date(element.start_date);
          let day = Math.round(Math.abs((firstDate - secondDate) / oneDay));
          let interest_amount = ((element.amount * 0.015)/30)*(day +1)
          this.total_amount += element.amount;
    ...
    close_memo() {
      this.open_memo = false;
      this.open_letter_other = false;
      this.set_debt_number = 3;
      this.memo_date_today =  moment(new Date().toJSON()).format("YYYY-MM-DD");
      this.version = false;
      this.set_memo = {
        memo_no: "",
        memo_date: "",
    ...
    SubmitInvoiceMain(name) {
      ...
      if (name == "unsubmitted") {
        this.axios
          .post(
            process.env.VUE_APP_API + "/debt/other/rpa/unsub",
            {
              uid: submitted,
            },
            headers
        ...
        this.axios
          ...
          .then(() => {
            this.axios
              .post(
                process.env.VUE_APP_API + "/debt/other/rpa",
                {
                  uid: submitted,
    ...
    save_letter_other(){
      ...
      this.modal_submit_all.forEach((element) => {
        data_list.push({
          invoice_no: element.invoice_no,
          memo_date: new Date(this.memo_date_today).toJSON(),
          memo_no: element.memo_no,
          memo_no_last: element.memo_no,
          debt_number: this.set_debt_number.toString(),
        })
      })
      ...
      this.axios
          .post(process.env.VUE_APP_API + "/debt/invoices/other", data_list, headers)
          .then((response) => {
                if (response) {
                  Swal.fire({
                    icon: "success",
    ...
    getInvoice() {
      ...
      this.axios
        .get(
          process.env.VUE_APP_API +
            "/debt/customer/debt_other?status=submitted&size=" +
...
#table_select_modal_letter_other {
  th {
    position: -webkit-sticky;
    position: sticky;
    top: 0;
