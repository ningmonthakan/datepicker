      ...
      <div>
        <v-row>
          <v-col
            ...
            "
          >
            <h3 style="font-weight:700">Matched</h3>
          </v-col>
          <v-col cols="12">
            <v-card>
              <!-----------------------------Tab Transfer/CHQ ------------------------------------>
              <v-card-text>
                <v-tabs v-model="tab" background-color="transparent">
                  <v-tab v-for="(item,index) in tab_items" :key="'tcs'+index">
                    {{ item }}
                  </v-tab>
                </v-tabs>
                      ...
                      <div class="table-invoice" style="position: relative">
                        ...
                        <!------------------------------=- filter Transfer---------------------------------->
                          <template v-slot:[`body.prepend`]>
                            <tr id="filter_matched">
                              <!-- filter document no -->
                              <td class="fixed-invoice-new">
                                <input
                                  v-model="document_no_transfer"
                                  class="form-control"
                                  @change="filter(document_no_transfer, String('document_no') , 'transfer')"
                                ...
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('document_no' ,'transfer')"
                                ...
                                <div>
                                  ...
                                  >
                                    <cv-date-picker
                                      ...
                                      @change="actionChange(action_date_range_transfer, 'action_date_transfer')"
                                  ...
                                  "
                                    >
                                      <button
                                        ...
                                        @click="blankModal('action_date', 'transfer')"
                                      >
                                        [Blank]
                                      </button>
                                      ...
                                      <div class="d-flex">
                                        <b-button
                                          ...
                                          @click="hideModal('action_date' , 'transfer')"
                                          >Cancel</b-button
                                        >
                                        <div style="width: 10px"></div>
                                        <b-button
                                          ...
                                          @click="OkFilterModal('action_date', 'transfer')"
                                          >OK</b-button
                                        >
                                      </div>
                                    </div>
                              ...
                              <td v-if="column_transfer[2].show == true">
                                <input
                                  ...
                                  class="form-control"
                                  @change="filter(customer_no_transfer, String('customer_no'), 'transfer')"
                                  placeholder="Cus no."
                                ...
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('customer_no', 'transfer')"
                              ...
                              <td v-if="column_transfer[3].show == true">
                                <v-autocomplete
                                  ...
                                  clearable
                                  dense
                                  :search-input.sync="search_customer_name_transfer"
                                  v-model="customer_name_transfer"
                                  type="text"
                                  label="Cus Name"
                                  :items="customer_name_list_transfer"
                                  @change="
                                    filter(customer_name_transfer, String('customer_name'), 'transfer')
                                  "
                                ></v-autocomplete>
                              </td>
                              <!-- filter วันที่ชำระ -->
                                  ...
                                  "
                                    >
                                      <button
                                        ...
                                        class="btn btn-link"
                                        style="margin-top: 14px"
                                        @click="blankModal('confirm_date', 'transfer')"
                                      >
                                        [Blank]
                                      </button>
                                      <div style="width: 160px"></div>
                                      <div class="d-flex">
                                        <b-button
                                          ...
                                          class="mt-3"
                                          variant="outline-danger"
                                          @click="hideModal('confirm_date' , 'transfer')"
                                          >Cancel</b-button
                                        >
                                        <div style="width: 10px"></div>
                                        <b-button
                                          ...
                                          class="mt-3"
                                          variant="outline-primary"
                                          @click="OkFilterModal('confirm_date', 'transfer')"
                                          >OK</b-button
                                        >
                                      </div>
                                    </div>
                              ...
                              <td v-if="column_transfer[5].show == true">
                                <v-autocomplete
                                  ...
                                  @change="
                                    filter(payment_type_bank_transfer, String('payment_type_bank'), 'transfer')
                                  "
                                ></v-autocomplete>
                              </td>
                              <!-- filter รวมยอดชำระ -->
                              <td v-if="column_transfer[6].show == true">
                                <v-autocomplete
                                  ...
                                  @change="filter(sum_amounts_transfer, String('sum_amounts'),String('transfer'))"
                                  item-text="name"
                                ></v-autocomplete>
                              </td>
                              ...
                              <td v-if="column_transfer[7].show == true">
                                <v-autocomplete
                                  ...
                                  :items="pay_list"
                                  @change="filter(status_file_transfer, String('status_file'), 'transfer')"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <!-- filter file หลักฐาน -->
                              <td v-if="column_transfer[8].show == true"></td>
                              <!-- filter wht -->
                              <td v-if="column_transfer[9].show == true">
                                <v-autocomplete
                                  multiple
                                  ...
                                  style="font-size:14px"
                                  :items="wht_list"
                                  @change="filter(check_wht_transfer, String('check_wht'), 'transfer')"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <td v-if="column_transfer[10].show == true">
                                <v-autocomplete
                                  ...
                                  style="font-size:14px"
                                  :items="file_wht_list"
                                  @change="filter(status_file_wht_transfer, String('status_file_wht'), 'transfer')"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <!-- filter file wht -->
                              <td v-if="column_transfer[11].show == true"></td>
                              <!-- filter Mail WHT -->
                              <td v-if="column_transfer[12].show == true">
                                <v-autocomplete
                                  multiple
                                  ...
                                  @change="filter(check_mail_wht_transfer, String('check_mail_wht'),String('transfer'))"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <td v-if="column_transfer[13].show == true">
                                <input
                                  ...
                                  @change="filter(request_day_transfer, String('request_day'), 'transfer')"
                                  :disabled="request_day_blank_transfer == true"
                                />
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('request_day', 'transfer')"
                              ...
                              <td v-if="column_transfer[14].show == true">
                                <input
                                  ...
                                  placeholder="Remark"
                                  style="font-size:14px"
                                  @change="filter(remark_transfer, String('remark'), 'transfer')"
                                  :disabled="remark_blank_transfer == true"
                                />
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('remark', 'transfer')"
                              ...
                              <td v-if="column_transfer[15].show == true">
                                <v-autocomplete
                                  ...
                                  @change="filter(user_name_transfer, String('action_by_name'), 'transfer')"
                                ></v-autocomplete>
                              </td>
                              <!-- filter action -->
                              <td v-if="column_transfer[16].show == true"></td>
                            </tr>
                          </template>
                        <!-------------------------------- end filter Transfer------------------------------>
                            ...
                            <tr id="filter_matched">
                              ...
                              <td class="fixed-invoice-new">
                                <input
                                  ...
                                  class="form-control"
                                  @change="filter(document_no_chq, String('document_no') , 'chq')"
                                  placeholder="Document No"
                                ...
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('document_no' , 'chq')"
                                ...
                                <div>
                                  ...
                                  >
                                    <cv-date-picker
                                      ...
                                      :date-end-label="dateEndLabel"
                                      :cal-options="calOptions"
                                      @change="actionChange(action_date_range, 'action_date')"
                                      v-model="action_date_range"
                                    >
                                    </cv-date-picker>
                                    <div
                                      style="
                                  ...
                                  "
                                    >
                                      <button
                                        ...
                                        class="btn btn-link"
                                        style="margin-top: 14px"
                                        @click="blankModal('action_date', 'chq')"
                                      >
                                        [Blank]
                                      </button>
                                      <div style="width: 160px"></div>
                                      <div class="d-flex">
                                        <b-button
                                          ...
                                          class="mt-3"
                                          variant="outline-danger"
                                          @click="hideModal('action_date', 'chq')"
                                          >Cancel</b-button
                                        >
                                        <div style="width: 10px"></div>
                                        <b-button
                                          ...
                                          class="mt-3"
                                          variant="outline-primary"
                                          @click="OkFilterModal('action_date' , 'chq')"
                                          >OK</b-button
                                        >
                                      </div>
                                    </div>
                              ...
                              <td v-if="column_chq[2].show == true">
                                <input
                                  v-model="customer_no"
                                  class="form-control"
                                  @change="filter(customer_no, String('customer_no'), 'chq')"
                                  placeholder="Cus no."
                                ...
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('customer_no', 'chq')"
                              ...
                              <td v-if="column_chq[3].show == true">
                                <v-autocomplete
                                  ...
                                  @change="
                                    filter(customer_name_chq, String('customer_name'), 'chq')
                                  "
                                ></v-autocomplete>
                              </td>
                              <!-- filter วันที่ชำระ -->
                                  ...
                                  "
                                    >
                                      <button
                                        ...
                                        class="btn btn-link"
                                        style="margin-top: 14px"
                                        @click="blankModal('confirm_date', 'chq')"
                                      >
                                        [Blank]
                                      </button>
                                      <div style="width: 160px"></div>
                                      <div class="d-flex">
                                        <b-button
                                          ...
                                          class="mt-3"
                                          variant="outline-danger"
                                          @click="hideModal('confirm_date', 'chq')"
                                          >Cancel</b-button
                                        >
                                        <div style="width: 10px"></div>
                                        <b-button
                                          ...
                                          class="mt-3"
                                          variant="outline-primary"
                                          @click="OkFilterModal('confirm_date', 'chq')"
                                          >OK</b-button
                                        >
                                      </div>
                                    </div>
                              ...
                              <td v-if="column_chq[5].show == true">
                                <v-autocomplete
                                  ...
                                  :items="payment_type_list"
                                  @change="
                                    filter(payment_type_bank, String('payment_type_bank'), 'chq')
                                  "
                                ></v-autocomplete>
                              </td>
                              <!-- filter รวมยอดชำระ -->
                              <td v-if="column_chq[6].show == true">
                                <v-autocomplete
                                  ...
                                  label="รวมยอดชำระ"
                                  :items="sum_amounts_list"
                                  @change="filter(sum_amounts_chq, String('sum_amounts'),String('chq'))"
                                  item-text="name"
                                ></v-autocomplete>
                              </td>
                              <!-- filter หลักฐานการชำระ -->
                              <td v-if="column_chq[7].show == true">
                                <v-autocomplete
                                  ...
                                  label="หลักฐานการชำระ"
                                  :items="pay_list"
                                  @change="filter(status_file, String('status_file'), 'chq')"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <!-- filter file หลักฐาน -->
                              <td v-if="column_chq[8].show == true"></td>
                              <!-- filter wht -->
                              <td v-if="column_chq[9].show == true">
                                <v-autocomplete
                                  ...
                                  style="font-size:14px"
                                  :items="wht_list"
                                  @change="filter(check_wht, String('check_wht'), 'chq')"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <td v-if="column_chq[10].show == true">
                                <v-autocomplete
                                  multiple
                                  v-model="status_file_wht"
                                  type="text"
                                  label="เอกสาร WHT"
                                  style="font-size:14px"
                                  :items="file_wht_list"
                                  @change="filter(status_file_wht, String('status_file_wht'), 'chq')"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <!-- filter file wht -->
                              <td v-if="column_chq[11].show == true"></td>
                              <!-- filter Mail WHT -->
                              <td v-if="column_chq[12].show == true">
                                <v-autocomplete
                                  multiple
                                  ...
                                  style="font-size:14px"
                                  :items="check_wht_list"
                                  @change="filter(check_mail_wht_chq, String('check_mail_wht'),String('chq'))"
                                  auto-select-first
                                  dense
                                  item-text="name"
                                ></v-autocomplete>
                              ...
                              <td v-if="column_chq[13].show == true">
                                <input
                                  ...
                                  type="text"
                                  placeholder="Mail Confirm Invoice"
                                  @change="filter(request_day, String('request_day'), 'chq')"
                                  :disabled="request_day_blank_chq == true"
                                />
                                <div class="d-flex">
                                  <input
                                    type="checkbox"
                                    @change="blank_checkbox('request_day', 'chq')"
                              ...
                              <td v-if="column_chq[14].show == true">
                                <input
                                  ...
                                  placeholder="Remark"
                                  style="font-size:14px"
                                  @change="filter(remark, String('remark'), 'chq')"
                              ...
                              <!-- filter user -->
                              <td v-if="column_chq[15].show == true">
                                <v-autocomplete
                                  auto-select-first
                                  multiple
                                  clearable
                                  ...
                                  @change="filter(user_name, String('action_by_name'), 'chq')"
                                ></v-autocomplete>
                              </td>
                              <!-- filter action -->
                              <td v-if="column_chq[16].show == true"></td>
                            </tr>
                          </template>
                        <!-------------------------------- end filter CHQ------------------------------>
                        <template v-slot:[`item.document_no`]="{ item }">
...
export default {
  ...
  methods: {
    ...
    exportFileTransfer() {
      ...
      this.axios
        .get(process.env.VUE_APP_API + "/export/matched/Transfer", headers)
        .then((response) => {
          ...
          if (response.data) {
            ...
            fileLink.setAttribute("download", "export_matched_transfer.csv");
    ...
    exportFileCHQ() {
      ...
      this.axios
        .get(process.env.VUE_APP_API + "/export/matched/CHQ", headers)
        .then((response) => {
          // console.log(response)
          if (response.data) {
            const fileURL = window.URL.createObjectURL(response.data);
            const fileLink = document.createElement("a");
            fileLink.href = fileURL;
            fileLink.setAttribute("download", "export_matched_chq.csv");
            document.body.appendChild(fileLink);
            fileLink.click();
          }
      })
   ...
   async getTransfer() {
    ...
    await this.axios
        .get(
          process.env.VUE_APP_API +
            "/statement/getmatched/Transfer?size=" +
        ...
        .then((response) => {
          if (response.status === 200 && response.data.data !== null) {
            ...
            if (this.datalist_transfer !== null) {
                ...
                this.listfilter_data("", "user_name" , "transfer");
            }
          } else {
            this.finish = true;
            this.datalist_transfer = [];
    ...
    async setting_column_transfer(){
      ...
      for (let i = 0; i < this.headers_Transfer_CHQ.length; i++) {
        if (this.headers_Transfer_CHQ[i].value == "document_no") {
          this.show_column_transfer.push(this.headers_Transfer_CHQ[i]);
          this.column_select_transfer.push(this.headers_Transfer_CHQ[i]);
          this.list_column_transfer.push(this.headers_Transfer_CHQ[i]);
        }
      }
      this.axios
        .get(process.env.VUE_APP_API + "/setting/columns/list/statement/Matched/Transfer", headers)
        .then((response) => {
          for (let index = 0; index < this.column_transfer.length; index++) {
            if (this.column_transfer[index].value == "action_date") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "action_date" &&
                  response.data.action_date == true
                ) {
                  this.show_column_transfer.push(this.headers_Transfer_CHQ[k]);
                  this.column_select_transfer.push(this.headers_Transfer_CHQ[k]);
                  this.list_column_transfer.push(this.headers_Transfer_CHQ[k]);
                }
              }
            }
            ...
            if (this.column_transfer[index].value == "customer_no") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "customer_no" &&
            ...
            if (this.column_transfer[index].value == "customer_name") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "customer_name" &&
            ...
            if (this.column_transfer[index].value == "confirm_date") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "confirm_date" &&
            ...
            if (this.column_transfer[index].value == "payment_type_bank") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "payment_type_bank" &&
            ...
            if (this.column_transfer[index].value == "sum_amounts") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "sum_amounts" &&
            ...
            if (this.column_transfer[index].value == "status_file") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "status_file" &&
            ...
            if (this.column_transfer[index].value == "file") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "file" &&
            ...
            if (this.column_transfer[index].value == "check_wht") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "check_wht" &&
            ...
            if (this.column_transfer[index].value == "status_file_wht") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "status_file_wht" &&
            ...
            if (this.column_transfer[index].value == "file_wht") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "file_wht" &&
            ...
            if (this.column_transfer[index].value == "check_mail_wht") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "check_mail_wht" &&
            ...
            if (this.column_transfer[index].value == "request_day") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "request_day" &&
            ...
            if (this.column_transfer[index].value == "remark") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "remark" &&
            ...
            if (this.column_transfer[index].value == "action_by_name") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "action_by_name" &&
            ...
            if (this.column_transfer[index].value == "action") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  this.headers_Transfer_CHQ[k].value == "action" &&
            ...
            var sortt = this.headers_Transfer_CHQ;
        ...
        .catch((error) => {
          ...
          if(error){
            ...
            this.axios
              .put(
                process.env.VUE_APP_API + "/setting/columns/statement/Matched/Transfer",
                body_2,
                headers
              )
              .then((response) => {
    ...
    select_column_transfer(column, item) {
      if (column == false) {
        ...
        for (let index = 0; index < this.headers_Transfer_CHQ.length; index++) {
          if (item.name == this.headers_Transfer_CHQ[index].text) {
            this.show_column_transfer.splice(index, 0, this.headers_Transfer_CHQ[index]);
          }
        }
      }
      ...
      for (let j = 0; j < this.headers_Transfer_CHQ.length; j++) {
        for (let g = 0; g < this.show_column_transfer.length; g++) {
          if (this.headers_Transfer_CHQ[j].text == this.show_column_transfer[g].text) {
            this.list_column_transfer.push(this.headers_Transfer_CHQ[j]);
          }
        }
      }
    },
   ...
   async getCHQ() {
        ...
        .then((response) => {
          if (response.status === 200 && response.data.data !== null) {
            ...
            if (this.datalist_chq !== null) {
                ...
                this.listfilter_data("", "user_name" , "chq");
            }
          } else {
            this.finish = true;
            this.datalist_chq = [];
    ...
    async setting_column_chq(){
      ...
      for (let i = 0; i < this.headers_Transfer_CHQ.length; i++) {
        if (this.headers_Transfer_CHQ[i].value == "document_no") {
          this.show_column_chq.push(this.headers_Transfer_CHQ[i]);
          this.column_select_chq.push(this.headers_Transfer_CHQ[i]);
          this.list_column_chq.push(this.headers_Transfer_CHQ[i]);
        }
      }
      this.axios
        .get(process.env.VUE_APP_API + "/setting/columns/list/statement/Matched/Chq", headers)
        .then((response) => {
            ...
            if (this.column_chq[index].value == "action_date") {
              ...
              for (let k = 0; k < this.headers_Transfer_CHQ.length; k++) {
                if (
                  ...
                  this.show_column_chq.push(this.headers_Transfer_CHQ[k]);
                  this.column_select_chq.push(this.headers_Transfer_CHQ[k]);
                  this.list_column_chq.push(this.headers_Transfer_CHQ[k]);
                }
              }
            }
        ...
        .catch((error) => {
          ...
          if(error){
            ...
            this.axios
              .put(
                process.env.VUE_APP_API + "/setting/columns/statement/Matched/Chq",
                body_2,
                headers
              )
              .then((response) => {
    ...
    select_column_chq(column, item) {
      if (column == false) {
        ...
        for (let index = 0; index < this.headers_Transfer_CHQ.length; index++) {
          if (item.name == this.headers_Transfer_CHQ[index].text) {
            this.show_column_chq.splice(index, 0, this.headers_Transfer_CHQ[index]);
          }
        }
      }
      ...
      for (let j = 0; j < this.headers_Transfer_CHQ.length; j++) {
        for (let g = 0; g < this.show_column_chq.length; g++) {
          if (this.headers_Transfer_CHQ[j].text == this.show_column_chq[g].text) {
            this.list_column_chq.push(this.headers_Transfer_CHQ[j]);
          }
        }
      }
    },
  ...
  //  กดปุ่ม check
    Check(item){
        ...
        this.axios
        .get(process.env.VUE_APP_API + "/statement/detail/"+item.queue_no, headers_check)
        .then((response) => {
          // console.log(response)
      ...
      // this.type_matched_success = 'Matched'
    },
    edit_dialog(){
      this.getAll();
    },
    ...
    actionChange(date, name) {
      ...
      if (name == "action_date") {
        this.action_date[0] = date.startDate
          .split("/")
          .reverse()
          .join("-");
        this.action_date[1] = date.endDate
          .split("/")
          .reverse()
          .join("-");
      } 
    ...
    blankModal(name , filter_status) {
      if (filter_status == "transfer"){
        if (name == "action_date") {
          this.$refs["my-modal_action_date"].hide();
          this.action_date_transfer = ["0000-00-00"];
          this.text_action_date_transfer = "[blank]";
          this.filter(this.action_date_transfer, name , filter_status);
        ...
        if (name == "confirm_date") {
          ...
          this.filter(this.confirm_date_transfer, name , filter_status);
          this.confirm_date_range_transfer.startDate = null;
          this.confirm_date_range_transfer.endDate = null;
        }
      }
      if (filter_status == "chq"){
        if (name == "action_date") {
          this.$refs["my-modal_action_date"].hide();
          this.action_date = ["0000-00-00"];
          this.text_action_date = "[blank]";
          this.filter(this.action_date, name , filter_status);
          this.action_date_range.startDate = null;
          this.action_date_range.endDate = null;
        }
        if (name == "confirm_date") {
          this.$refs["my-modal_confirm_date"].hide();
          this.confirm_date = ["0000-00-00"];
          this.text_confirm_date = "[blank]";
          this.filter(this.confirm_date, name , filter_status);
          this.confirm_date_range.startDate = null;
          this.confirm_date_range.endDate = null;
        }
      }
    },
    hideModal(name , filter_status) {
      if (filter_status == "transfer"){
          if (name == "action_date"){
            this.$refs["my-modal_action_date"].hide();
            ...
            this.action_date_range_transfer.startDate = null;
            this.action_date_range_transfer.endDate = null;
            this.close_dialog(name , filter_status);
          }
          if (name == "confirm_date") {
            this.$refs["my-modal_confirm_date"].hide();
    ...
    OkFilterModal(name , status) {
      if (status == "transfer"){
        if (name == "action_date") {
          if (
              ...
              (this.action_date_transfer[0] == null && this.action_date_transfer[1] == "") ||
        ...
        if (name == "confirm_date") {
          if (
            ...
            (this.confirm_date_transfer[0] == null && this.confirm_date_transfer[1] == "") ||
      ...
      if (status == "chq"){
        ...
        if (
          this.action_date[0] == "" ||
          (this.action_date[0] == null && this.action_date[1] == "") ||
          this.action_date[1] == null
        ) {
          alert("กรุณาเลือกช่วงวันที่ให้ครบ");
        } else {
          this.$refs["my-modal_action_date"].hide();
          this.text_action_date =
            this.action_date[0]
              .split("-")
              .reverse()
              .join("/") +
            ...
            this.action_date[1]
              ...
              .reverse()
              .join("/");
          this.filter(this.action_date, name , status);
        }
      }
      if (name == "confirm_date") {
        if (
          ...
          this.text_confirm_date =
            ...
            this.confirm_date[1]
              ...
              .reverse()
              .join("/");
          this.filter(this.confirm_date, name , status);
        }
      }
      }
    },
    close_dialog(close , filter_status) {
        ...
        this.axios
          ...
          .then((response) => {
            ...
            if (this.filterlist.length == 0) {
              //this.getData_afterClearAll(filter_status);
              this.setting_column_transfer();
              this.getTransfer();
            }
        });
    ...
    filter(filter, key , filter_status) {
      // console.log(filter_status)
          ...
          .then((response) => {
            ...
            if (response.status === 200) {
                ...
                if (this.datalist_transfer == undefined || this.datalist_transfer == null) {
                  ...
                  this.finish = true;
                  // this.page_total_table_transfer = 1; //ใหม่
          ...
          .then((response) => {
            ...
            if (response.status === 200) {
                ...
                if (this.datalist_chq == undefined || this.datalist_chq == null) {
                  ...
                  this.finish = true;
                  // this.page_total_table_chq = 1; //ใหม่
    ...
    blank_checkbox(name , status) {
      if (name == "document_no") {
        if(status == "transfer"){
          if (this.document_no_blank_transfer == true) {
            this.document_no_transfer = "[blank]";
            this.filter("blank_string", "document_no" , 'transfer');
          } else {
            this.document_no_transfer = "";
            this.filter("", "document_no", 'transfer');
          }
        }else if (status == "chq"){
          if (this.document_no_blank_chq == true) {
            this.document_no_chq = "[blank]";
            this.filter("blank_string", "document_no" , 'chq');
          } else {
            this.document_no_chq = "";
            this.filter("", "document_no", 'chq');
          }
        }
      }
      if (name == "customer_no") {
