      ...
      <div>
        <v-row>
          <v-col
            ...
            "
          >
            <h3 style="font-weight:700">เอกสาร WHT</h3>
          </v-col>
          <v-col cols="3">
          ...
          <v-col cols="12">
            <v-card>
              ...
              <v-card-text>
                <!-- <download-csv :data="debt_data" name="export_receipt_all.csv"
                  ><v-btn
                    color="teal"
                    dark
                ...
                <div class="cover-table">
                  <div class="table-invoice" style="position: relative">
                    ...
                    >
                      ...
                      <template v-slot:[`item.mail_cus`]="{ item }">
                        <label>
                          {{ fomatEmail(item.mail_cus) }}
                        </label>
                      </template>
...
export default {
  ...
  methods: {
    ...
    exportAll(){
      ...
      this.axios
        .get(process.env.VUE_APP_API + "/export/log/logsendmailsrwht",headers)
        .then((response) => {
            if(response.status == 200) {
              const fileURL = window.URL.createObjectURL(response.data);
              const fileLink = document.createElement("a");
              fileLink.href = fileURL;
              fileLink.setAttribute("download", "export_request_wht_all.csv");
      ...
      this.axios
        .get(
          process.env.VUE_APP_API +
            "/getinvoicestatus/logsendmailsrwht?size=" +
            this.item_per_page +
            "&page=" +
            this.page +
            "&search=" +
