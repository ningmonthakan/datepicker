...
import DownloadDialog from '../components/DownloadDialog.vue'
  ...
  export default {
    ...
    created() {
      ...
      if (this.role.includes('ALL')||this.role.includes('HEAD_R&D')) {
        this.getdata ()
        this.getdata_amount ()
      }else {
    ...
    methods:{
      ...
      getdata () {
        ...
        this.axios.get(process.env.VUE_APP_API + '/dashboard/document/head/rd?page=' + this.page + '&status=' + this.status + '&search=' + this.search, headers).then((response) => {
          this.loading = false
