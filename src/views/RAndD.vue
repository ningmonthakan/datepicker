...
import DownloadDialog from '../components/DownloadDialog.vue'
  ...
  export default {
    ...
    created() {
      ...
      if (this.role.includes('ALL')||this.role.includes('R&D')) {
        this.getdata ()
        this.getdata_amount ()
      }else {
    ...
    methods:{
      ...
      getdata_amount () {
        ...
        this.axios.get(process.env.VUE_APP_API + '/dashboard/document/amount/rd', headers).then((response) => {
      ...
      getdata () {
        ...
        this.axios.get(process.env.VUE_APP_API + '/dashboard/document/rd?page=' + this.page + '&status=' + this.status + '&search=' + this.search, headers).then((response) => {
          this.loading = false
      ...
      put_status (status,remark,uid) {
        ...
        this.axios.put(process.env.VUE_APP_API + '/dashboard/document/status/' + uid, data, headers).then((response) => {
      ...
      put_transfer (cost_center, uid) {
        ...
        this.axios.put(process.env.VUE_APP_API + '/dashboard/document/transfer/' + uid, data, headers).then((response) => {
          console.log(response.data)
          this.$swal.fire({
              title: "สำเร็จ",
              icon: 'success',
