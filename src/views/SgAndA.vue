        ...
        <v-card>
          ...
          <v-card-title>
            ...
            <v-text-field
              ...
              hide-details
            ></v-text-field>
            <v-btn type="sumbit" color="primary">
              ค้นหา
              <v-icon
                right
                dark
...
import DownloadDialog from '../components/DownloadDialog.vue'
  ...
  export default {
    ...
    created() {
      ...
      if (this.role.includes('ALL')||this.role.includes('SG&A')) {
        this.getdata ()
        this.getdata_amount ()
      }else {
    ...
    methods:{
      ...
      getdata () {
        ...
        this.axios.get(process.env.VUE_APP_API + '/dashboard/document/sga?page=' + this.page + '&status=' + this.status + '&search=' + this.search, headers).then((response) => {
          this.loading = false
