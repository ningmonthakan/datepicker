      ...
      <v-card>
            ...
            <v-row>
              ...
              <v-col cols="3" sm="3" md="3">
                ...
                >
                  ...
                  <v-list-item
                    v-if="(customer_email == '' && check_code != true) || check_add_invoice != true"
                    color="gray"
                    disabled
                  >
                  ...
                  <v-list-item
                    v-if="status_mail_invoice == false && customer_email != '' && check_req_mail_WHT !== true && check_code != true && check_add_invoice != false"
                    color="rgb(103, 194, 93)"
                  ...
                  <v-list-item
                    v-if="status_mail_wht == false && customer_email != '' && check_req_mail !== true && check_code != true && check_add_invoice != false"
                    color="gray"
                ...
                >
                  <table style="width: 100%">
                    ...
                    >
                      ...
                      <td v-if="item.temp_id" style="width: 20%;" class="invoice-header-data">
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            outlined
            :disabled="
              files == '' ||  select_special_code == '' || (evidence_reporting == '' && data_matching.type != 'CHQ') 
            "
          >
            Matching
          </v-btn>
          <v-btn
            ...
            :disabled="
                ...
                (transfer_suspense[0].payment_type_bank == '' && select_special_code != '01') || (valid_no == false && select_special_code != '01') || check_add_invoice == false ||
...
export default {
  ...
  mounted() {
    eventBus.$on("addMatchingDialog", this.open);
  },
  beforeDestroy() {
    eventBus.$off("addMatchingDialog");
    // bus.$off()
  },
  computed: {
    items() {
  ...
  methods: {
    ...
    open(item, select_type_bank , index) {
      ...
      if (item) {
        ...
        this.evidence_reporting = this.customer_detail[0].evidence_reporting;
        this.remark = this.customer_detail[0].remark;
        this.remark_erp = this.customer_detail[0].remark_erp;
        this.WHT_list = this.customer_detail[0].WHT_list;
        this.files = this.customer_detail[0].files;
        this.files_wht = this.customer_detail[0].files_wht;
    ...
    async save(type) {
      ...
      var tax = "";
            ...
            this.axios
              .post(process.env.VUE_APP_API + "/statement/add_statement/total", Datas, headers)
              .then((response) => {
                if(response.status == 200){
                  Swal.fire({
                    icon: "success",
